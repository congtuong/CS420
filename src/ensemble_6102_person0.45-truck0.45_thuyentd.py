...
for image_path in tqdm(list(test_path.glob("*.png"))):
    ...
    car_threshold = 0.25
    bike_threshold = 0.25
    perdestrian_threshold = 0.25
    truck_threshold = 0.35

    # bus_threshold = 0.35
    # car_threshold = 0.28
    # bike_threshold = 0.28
    # perdestrian_threshold = 0.28
    # truck_threshold = 0.35

    # bus_threshold = 0.4
    # car_threshold = 0.3
    # bike_threshold = 0.3
    # perdestrian_threshold = 0.45
    # truck_threshold = 0.45
    ...
    def check_inside(boxes_t):
        center_t = (
            int((boxes_t[0] + boxes_t[2]) / 2),
            int((boxes_t[1] + boxes_t[3]) / 2),
        )
...
# 0.292: predictions_baotg_test_6102_test_thuyentd_inside_outside_bike-person-car0.25-bus-truck0.35_095_080_095_075_095.json 
# 0.29


with open(
    result_path
    / "predictions_baotg_test_6102_test_thuyentd_inside_outside_bike-person-car0.25-bus-truck0.35_095_085_095_075_095.json",
    "w+",
) as f:
    json.dump(result, f)
