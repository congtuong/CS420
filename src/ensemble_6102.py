...
input_path_list = [
    ...
    ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/temp/codetr_closs.json", 2),

    # YOLOR, 1920
    ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/temp/yolor_1920.json", 1),
...
def load_predictions(input_path, image_path, conf_thres):
    ...
    for idx, pred in enumerate(input_path):
        ...
        for item in data:
            ...
            # if item['bbox'][2] * item['bbox'][3] < min_size:
            #     continue
...
with open(result_path / "predictions_baotg_test_6102_test.json", "w+") as f:
    json.dump(result, f)
