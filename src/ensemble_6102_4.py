...
input_path_list = [
    ...
    ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/temp/codetr_original_max_91.json", 3),
    ...
    ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/temp/codetr_closs.json", 3),
...
with open(result_path / "predictions_baotg_test_6102_test_4.json", "w+") as f:
    json.dump(result, f)
