...
labels_path = Path(
    ...
    "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/tuongbck/ensemble/predictions_hienht_temp_1.json"
    # "/mlcv1/WorkingSpace/Personal/hienht/aic24/mmdetection/pred_dino_origin.json"
    # "/mlcv1/WorkingSpace/Personal/hienht/aic24/NWD/result_no_thr.json"
)

output_path = Path(
    # "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/visualize_coco_codetr"
    "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/src/visualize_coco_hienht"
)
conf = 0.3
