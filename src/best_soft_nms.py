...
input_path_list = [
    ...
    # ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/tuongbck/ensemble/predictions_tuongbck_distance_algo_thuyentd_2.json",1),
    ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/predictions/predictions_best_f1.json",1),
    
    # ("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/predictions_codetr_0_001.json", 1),
...
with open(result_path / "predictions_tuongbck.json", "w+") as f:
    json.dump(result, f)
