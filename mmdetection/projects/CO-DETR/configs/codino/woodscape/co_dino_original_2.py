...
load_from = "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/CoDETR/mmdetection/work_dirs/co_dino_12g_pretrain_woodscape/epoch_10.pth"  # noqa
...
model = dict(
    ...
    #     init_cfg=dict(
    #         type="Pretrained",
    #         checkpoint="https://download.openmmlab.com/mmpretrain/v1.0/eva02/eva02-large-p14_pre_m38m_20230505-b8a1a261.pth",
    #         prefix="backbone.",
    #     ),
    # ),
    backbone=dict(
...
activation_checkpointing = ['backbone']