...
data_root = "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/hienht/mmdetection/splited_data"
backend_args = None
...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_root=data_root,
        ann_file="new_split_data_train.json",
...
val_dataloader = dict(
    ...
    dataset=dict(
        ...
        # classes=classes,
        data_root=data_root,
        ann_file="new_split_data_val.json",
        data_prefix=dict(img="images"),
        backend_args=backend_args,
    ),
)
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + "/new_split_data_val.json",  # Annotation file path
    metric=[
        "bbox"
