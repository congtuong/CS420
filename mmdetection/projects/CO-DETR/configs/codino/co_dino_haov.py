...
data_root = '/mlcv1/WorkingSpace/Personal/haov/aicity2024/module/clf/hank/'
backend_args = None
...
train_dataloader = dict(
    batch_size=1, num_workers=4, dataset=dict(
        type=dataset_type,
        # classes=classes,
        ...
        ann_file="train.json",
        data_prefix=dict(img='yolo/images/train/images/'),
