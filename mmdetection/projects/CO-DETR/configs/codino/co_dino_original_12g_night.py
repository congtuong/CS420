...
data_root = "/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/CoDETR/data/yolo_all_classes_split/night/all"
backend_args = None
...
val_evaluator = dict(  # Validation evaluator config
    ...
    ann_file=data_root + "/val_codetr.json",  # Annotation file path
    metric=[
        "bbox"
