...
sys.path.append("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/CoDETR/mmdetection")
sys.path.append("/mlcv1/WorkingSpace/Personal/tuongbck/AIC2024/CoDETR/mmcv")
...
def parse_args():
    ...
    parser.add_argument(
        "--pred-score-thr", type=float, default=0.1, help="bbox score threshold"
    )
    parser.add_argument(
...
def main():
    ...
    # print(inferencer.model.test_cfg)
    inferencer.model.test_cfg.append(
        {
            "chunked_size": chunked_size,
        }
    )

    inferencer.model.test_pipeline = [
    ...
    # inferencer.model.test_cfg = [
    #     dict(max_per_img=1000, nms=dict(iou_threshold=0.8, type="soft_nms")),
    #     dict(
    #         rcnn=dict(
    #             max_per_img=300, nms=dict(iou_threshold=0.5, type="nms"), score_thr=0.0
    #         ),
    #         rpn=dict(
    #             max_per_img=1000,
    #             min_bbox_size=0,
